...
- **MSRV raised from 1.75 to 1.80** — Rust 1.80 introduced `LazyLock` and stabilised several APIs used by transitive dependencies; update your toolchain accordingly
